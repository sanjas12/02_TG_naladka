...
if __name__ == '__main__':
    ...
    # кнопка Any.
    any_channel = Button(win_1, text="Any")
    any_channel.grid(in_=frame_b, sticky=S, row=2, column=2)
    any_channel.bind('<ButtonRelease-1>', any)
