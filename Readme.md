...
Каждый выбранный сигнал отображается на собственной шкале Y при общей оси X.
...
12. docs(graph): обновить оформление временной оси графиков

- Привести ось времени к виду анализа архивов PLC
- Добавить дату под осью для диапазонов
- Автоматически подбирать точность времени
- Улучшить читаемость меток времени
- Добавить тесты для проверки форматирования
