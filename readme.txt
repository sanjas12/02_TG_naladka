1.  grath_from_tg_static_8.py - текущая версия программы (GUI-tkinter)
    ...
    1_1 TG_pyQt_06 - Текущая GUI-QT версия программы
    1_2 TG_pyQt_07 - Экспериментальная - каждое окно импортируется через import
    1.3 TG_pyQt_08 - экспериментальная, попытка добавить возможность выбора любого  графика через кнопку "Any"
