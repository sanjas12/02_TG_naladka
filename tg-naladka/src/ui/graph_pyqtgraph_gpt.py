# tg-naladka/src/ui/graph_pyqtgraph.py
...
class WindowGraph(QMainWindow):
    ...
    Использует pyqtgraph вместо matplotlib.
    """
    ...
    def init_ui(self) -> None:
        ...
        self.vline.hide()
        self.annotation = pg.TextItem(anchor=(0, 1), border=pg.mkPen(0.5),
                                      fill=(255, 255, 255, 200))
        self.plot_item.addItem(self.annotation)
        self.annotation.hide()

        proxy = pg.SignalProxy(self.plot_item.scene().sigMouseMoved,
                               rateLimit=60, slot=self.on_mouse_move)
